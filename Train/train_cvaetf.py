...
def train_model(args, model, optimizer, train_iter, valid_iter, device, LOG):
    beta = 0
    ...
    for epoch in range(args.start_epoch, args.num_epoch+1):
        ...
        dataloader = get_loader(
            train_iter, args.property_list, args.pad_id,
        ...
        save_checkpoint(args, model, optimizer,
                        os.path.join(args.model_folder, f'model_{epoch}.pt'))